...
const PocetnaStranica = ({
  ...
  const povuciEpizodu = useCallback(async () => {
    if (korisnik) {
      const response = povuciPodatke(`povuci_epizodu&jmbg=3107018100555`, 'GET');
  ...
  return (
    <div className={styles.mainDiv}>
      ...
      <div className={styles.mainDiv}>
        {!korisnik ? <PocetnaStranicaNemaKorisnika setTrenutnaStranicaApp={setTrenutnaStranicaApp}
            ...
            <>
              ...
              <div className={styles.dat_rodAdresa}>
                ...
                <h3>
                  ...
                  <OdabirPregleda selectedOption={selectedOption} setSelectedOption={setSelectedOption}/>
                </h3>
              </div>
              <div className={styles.buttons}>
                ...
                <Button
                  ...
                  onClick={() => selectedOption === '4' ? setKorak(6) : setKorak(1)}
                  text={'DA'}
                />
              </div>
            </>
